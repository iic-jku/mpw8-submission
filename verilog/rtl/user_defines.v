...
`define USER_CONFIG_GPIO_5_INIT  `GPIO_MODE_MGMT_STD_INPUT_PULLUP
...
`define USER_CONFIG_GPIO_30_INIT `GPIO_MODE_MGMT_STD_ANALOG
`define USER_CONFIG_GPIO_31_INIT `GPIO_MODE_MGMT_STD_ANALOG
